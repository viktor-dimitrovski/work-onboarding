...
export const MODULES: ModuleDefinition[] = [
  ...
  },
  {
    ...
    navItems: [
      ...
      {
        href: '/assessments/my-profile',
        label: 'My Star Profile',
        icon: Star,
        moduleKey: 'assessments',
        permission: 'assessments:take',
      },
  ...
  },
  {
    ...
    description: 'Platform releases, release notes, work orders, and release center.',
    icon: Rocket,
    defaultHref: '/platform-releases',
    routeMatchers: ['/platform-releases', '/release-notes', '/release-center', '/release-calendar', '/work-orders', '/release-manifests', '/release-management'],
    moduleKeys: ['releases'],
    navItems: [
      {
